...
export const article = {
  author: 'Guy Koomer',
  date: '2024-01-15',
  title: 'Streaming Advertisements: Making your local brand look worldwide',
  description:
    'When you’re building a marketing strategy for a company that has ambition, you need to make an impression. I wanted people to visit our website and see animations that looked more realistic than reality itself.',
}
