...
export const article = {
  author: 'Guy Koomer',
  date: '2022-09-02',
  title: 'Streaming Ads: Making your local brand look National ',
  description:
    'When you’re building a website and a marketing plan for an ambitious company, you need to make an impression. When everyone else is doing the same old Instagram ads how can you set yourself apart.',
}
...
When you’re building a website and a marketing plan for an ambitious company , you need to make an impression. When everyone else is offering the same old Instagram ads and Google Ad Click Campaigns a freelance web developer has to set themselves apart. I wanted people to visit our website and see animations that looked more realistic than reality itself.
