...
import webDeveloper from '@/images/web_developer.jpg'
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            I’m Guy Koomer. I live in Los Angeles, where I help businesses from
            the small all the way up to the enterprise level.
          </h1>
          <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
            ...
            <p>
              My goal is to work collabaratively with you to develop a
              comprehensive strategy that aligns with your business objectives
        ...
        <div className="lg:pl-20">
          <ul role="list">
            ...
            <SocialLink
              href="mailto:guy@salientdynamics.com"
              icon={MailIcon}
              className="mt-8 border-t border-zinc-100 pt-8 dark:border-zinc-700/40"
            >
              guy@salientdynamics.com
            </SocialLink>
          </ul>
        </div>
      </div>
